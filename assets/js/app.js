...
;
  ...
  Sockets.Patients = (function(superClass) {
    extend(Patients, superClass);

    function Patients() {
      return Patients.__super__.constructor.apply(this, arguments);
    }

    Patients.prototype.model = Sockets.Patient;
